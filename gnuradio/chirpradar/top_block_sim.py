...
class top_block_sim(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Chirp Radar Simulation")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Chirp Radar Simulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "top_block_sim")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 600000000
        ...
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, int(2*628000000), 1)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.01)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'beat_signal_simulated.dat', True)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 8)
        self.blocks_complex_to_real_0_0 = blocks.complex_to_real(1)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_freq_sink_x_1_0, 0))
        ...
        self.connect((self.hilbert_fc_0, 0), (self.qtgui_time_sink_x_0_1, 0))
...
def main(top_block_cls=top_block_sim, options=None):
