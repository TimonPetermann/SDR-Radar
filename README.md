...
SDR-Positioning-System is misleading - the origianl Idea was to implement a positioning system based on SDR radar. However, this turned to be to complex. Instead two different continuous wave radar system were implemented using GNU radio and two Pluto SDRs.
